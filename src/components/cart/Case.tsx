...
const Case = () => {
  return (
    <Link className="relative cursor-pointer w-[10.3125rem] h-[10.8125rem] sm:w-64 sm:h-[16.6875rem]" href={'/cases/1'}>
      <Image className={style.image + ' absolute z-10 right-0 left-0 mx-auto my-auto -top-6 sm:-top-4 w-[145px] h-[145px] sm:w-[212px] sm:h-[212px]'} src={'/img/example/batman-def.png'} alt={'batman'} width={212} height={212} />
      ...
      <div className="relative flex flex-col items-center justify-end overflow-hidden w-[10.3125rem] h-[10.8125rem] sm:w-64 sm:h-[16.6875rem] rounded-[1.375rem] border-0 border-[#ffffff]/[.1] gap-2 sm:gap-4 bg-contain bg-repeat" style={{ background: "url(/img/interface/bg/case.png)" }}>
        ...
        <div className="mb-4 sm:mb-8 z-20 text-xs sm:text-[1.1875rem] font-bold leading-[normal]">BATMAN</div>
      </div >
    </Link>
  )
}
